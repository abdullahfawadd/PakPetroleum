  ...
  return (
    <div className={className}>
      <Canvas dpr={[1, 2]} gl={{ antialias: true, alpha: true }}>
        {/* ⚡ Bolt Optimization: Use PerformanceMonitor and AdaptiveDpr to dynamically reduce rendering resolution when the frame rate drops, ensuring smooth scrolling and avoiding GPU stalls. */}
        <PerformanceMonitor>
