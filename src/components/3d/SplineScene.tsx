  ...
  return (
    <div className={className}>
      <Canvas dpr={[1, 2]} gl={{ antialias: true, alpha: true }}>
        {/* ⚡ Bolt Optimization:
         * Add PerformanceMonitor and AdaptiveDpr to dynamically reduce rendering resolution
         * when the frame rate drops. This ensures smooth scroll performance on lower-end devices
         * without forcing high-res rendering on all screens.
         */}
        <PerformanceMonitor />
