  ...
  return (
    <div className={className}>
      <Canvas dpr={[1, 2]} gl={{ antialias: true, alpha: true }}>
        {/* ⚡ Bolt Optimization: Dynamic Resolution Scaling
            AdaptiveDpr listens to PerformanceMonitor and automatically lowers
            the device pixel ratio (DPR) to 1x when frame rates drop below 60fps,
            preventing jank on low-end devices or during heavy scroll events. */}
        <PerformanceMonitor>
