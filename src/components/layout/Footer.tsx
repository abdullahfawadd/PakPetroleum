          ...
          <div className="lg:col-span-1">
            <Link href="#home" className="inline-block mb-5">
              <span className="text-2xl font-bold tracking-tight">
                <span className="text-primary-400">PAK</span>
                <span className="text-white ml-1">Petroleum</span>
              </span>
            </Link>

            <p className="text-dark-100 leading-relaxed mb-6 max-w-xs">
              ...
              {SOCIAL_LINKS.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 rounded-lg bg-dark-400 flex items-center justify-center text-dark-100 hover:bg-primary-500 hover:text-white transition-all duration-300"
                  >
            ...
            <ul className="space-y-3">
              {QUICK_LINKS.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-dark-100 hover:text-primary-400 transition-colors duration-300 text-sm"
                  >
                    {link.name}
                  </Link>
                </li>
