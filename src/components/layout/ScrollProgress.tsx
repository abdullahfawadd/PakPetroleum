...
export default function ScrollProgress() {
  ...
  useEffect(() => {
    ...
    const updateProgress = () => {
      ...
      if (barRef.current) {
        // ⚡ Bolt: Offload high-frequency updates to the GPU compositor
        // by modifying `transform` instead of layout-triggering `width`.
  ...
  return (
    ...
    >
      <div
        ref={barRef}
        className="h-full gradient-bar origin-left w-full"
