...
export default function MetricsTrust() {
  ...
  const containerRef = useGSAP<HTMLElement>(() => {
    ...
    // ⚡ Bolt Optimization: Replace slow DOM querying (querySelectorAll/getAttribute)
    // inside the GSAP effect with direct React refs and constant data mapping.
    // This eliminates "DOM Read Inside Loop" layout thrashing and reduces setup overhead.
