...
export default function MetricsTrust() {
  ...
  const containerRef = useGSAP<HTMLElement>(() => {
    ...
    // ⚡ Bolt Optimization:
    // Replaced DOM queries (querySelectorAll) and attribute reads (getAttribute) inside the animation setup
    // with React refs mapping directly to source data constants to eliminate DOM read overhead.
