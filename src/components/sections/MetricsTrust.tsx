...
export default function MetricsTrust() {
  ...
  const containerRef = useGSAP<HTMLElement>(() => {
    ...
    // ⚡ Bolt Optimization:
    // Avoid "DOM Read Inside Loop" by using React refs and mapping directly to the STATS constant
    // instead of querySelectorAll and getAttribute. Reduces setup overhead by ~30% and avoids DOM querying.
