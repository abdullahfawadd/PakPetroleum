...
// ⚡ Bolt: Extracted CardContent outside of EnterpriseCard render function
// to prevent React from unnecessarily unmounting and remounting the DOM
// subtree on every render cycle due to component reference changing.
const CardContent = ({
  icon: Icon,
  title,
  description,
  className,
  actionLabel,
}: Omit<EnterpriseCardProps, "href" | "onClick">) => (
  <div
    className={cn(
...
export function EnterpriseCard({
  ...
  const contentProps = { icon, title, description, className, actionLabel };
